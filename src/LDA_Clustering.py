...
def GetData():
    DataRaw = ExecuteQuery("SELECT TOP 9500 ID, Features F, Target T FROM dbo.DataForTrain")
    Data = []
    for row in DataRaw:
        try:
...
def Main():
    ...
    # SOM_Clustering(Lda, 3)
    # SOM_Clustering(Lda, 5)
    # SOM_Clustering(Lda, 7)
    # SOM_Clustering(Lda, 9)
    # SOM_Clustering(Lda, 11)
    # SOM_Clustering(Lda, 13)
    # SOM_Clustering(Lda, 15)

    # SOM_BAT_Clustering(Lda, 3)
    # SOM_BAT_Clustering(Lda, 5)
    # SOM_BAT_Clustering(Lda, 7)
    # SOM_BAT_Clustering(Lda, 9)
    # SOM_BAT_Clustering(Lda, 11)
    # SOM_BAT_Clustering(Lda, 13)
    # SOM_BAT_Clustering(Lda, 15)
    
    # DBSCAN_Clustering(Lda, 3)
    # DBSCAN_Clustering(Lda, 5)
    # DBSCAN_Clustering(Lda, 7)
    # DBSCAN_Clustering(Lda, 9)
    # DBSCAN_Clustering(Lda, 11)
    # DBSCAN_Clustering(Lda, 13)
    # DBSCAN_Clustering(Lda, 15)
